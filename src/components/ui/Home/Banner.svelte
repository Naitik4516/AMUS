...
<div
    class="relative w-full h-90 max-h-3/5 md:min-h-120 md:h-full rounded-[4rem] bg-linear-to-br from-secondary/60 via-secondary/20 to-slate-900 border mt-4 overflow-hidden group"
>
    <div
