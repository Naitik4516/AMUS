...
>
    <div class="flex gap-15 items-end p-5 pb-30 rounded-t-2xl bg-linear-to-b from-rose-600 via-pink-900 to-fuchsia-950/20 ">
        <div class="flex items-center justify-center rounded-2xl w-60 h-60 bg-rose-600">
    ...
    {#if tracks.length > 0}
        <div class="-translate-y-22">
            <TrackList context="liked" {tracks} />
        </div>
    {:else}
        <div
        ...
        >
            ...
            <p class="text-sm">You haven't added any tracks to your favourites yet.</p>
        </div>
    {/if}
</div>
